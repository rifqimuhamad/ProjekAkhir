        ...
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="#courses" style="text-decoration:none">Courses</a></li>
                    <li><a href="#tutors" style="text-decoration:none">Tutors</a></li>
                    <li><a href="#partners" style="text-decoration:none">Partners</a></li>
                    <li><a href="#contact" style="text-decoration:none">Contact</a></li>
                    <li><a href="" class="tbl-biru" style="text-decoration:none">Sign Up</a></li>
                </ul>
            </div>
        </div>
    </nav>
